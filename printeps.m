function printeps(fignum, figname, fontName)
% printeps(fignum, figname, fontName)
...
% printeps(1,'test','Arial');                       %print the contents of figure 1
%      
%to test.eps.
%
% Modified by Mani Subramaniyan 2013-01-31
%
...
for k = 1:length(mlabfontlist)
    ff = strrep(ff,mlabfontlist{k},fontName);
end
